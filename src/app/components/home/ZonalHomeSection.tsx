...
export const ZonalHomeSection: FC<ZonalHomeSectionProps> = ({ torneo }) => (
  <section className="w-full px-6 md:px-10 py-8" style={{ backgroundColor: "#0a0a0a" }}>
    <p className="text-xs font-semibold uppercase tracking-widest mb-1" style={{ color: "var(--color-primary)" }}>
      Torneo Zonal
    </p>
    <h2 className="text-white text-xl md:text-2xl font-extrabold uppercase tracking-tight mb-4">
      {torneo.name}
    </h2>
