  ...
  return (
    <section className="w-full">
      ...
      <div
        ...
        style={{ backgroundColor: tenantConfig.brand.secondaryColor }}
      >
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`whitespace-nowrap px-4 py-2 rounded-t-lg text-sm font-medium transition-colors flex-shrink-0 ${isSelected
